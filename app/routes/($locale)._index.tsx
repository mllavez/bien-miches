  ...
  return (
    <div className="md:container md:mx-auto ">
      <div className="bg-first-hero-img bg-cover h-screen w-screen bg-center text-white flex flex-col justify-start items-center gap-[22px]">
        ...
        <button
          className="h-[45px] py-2 bg-rose-700 rounded-lg justify-center items-center inline-flex w-screen"
          onClick={() => {
        ...
        <button className="h-[45px] py-2 bg-rose-700 rounded-lg justify-center items-center inline-flex w-screen">
          ADD TO CALENDAR
        </button>
        <LaunchForm />
      </div>
